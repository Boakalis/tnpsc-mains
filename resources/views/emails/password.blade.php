                                                        ...
                                                        <tr>
                                                            <td style="width:100%;padding-right:0px;padding-left:0px;">
                                                                <div align="center" style="line-height:10px"><img
                                                                        ...
                                                                        class="big"
                                                                        src="data:image/png;base64,{{base64_encode(file_get_contents(public_path("images/animated_header.gif")))}}"

                                                                        {{-- src="{{asset("images/animated_header.gif")}} --}}
                                                                   ...
                                                                   ><span
                                                                        style="padding-left:25px;padding-right:20px;font-size:15px;display:inline-block;letter-spacing:normal;"><span
                                                                            style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><span
                                                                                ...
                                                                                style="font-size: 15px; line-height: 30px;"><strong>{{@$details['otp']}}</strong></span></span></span></a>
                                                        ...
                                                        <tr>
                                                            <td style="width:100%;padding-right:0px;padding-left:0px;">
                                                                <div align="center" style="line-height:10px"><img
                                                                        ...
                                                                        class="big"
                                                                        src="data:image/png;base64,{{base64_encode(file_get_contents(public_path('/images/bottom_img.png')))}}"
                                                                        {{-- src="{{asset("/images/bottom_img.png")}}" --}}
                                                                        style="display: block; height: auto; border: 0; width: 600px; max-width: 100%;"
