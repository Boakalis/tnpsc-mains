<div>
    <div class="">
        <div class="row">
            ...
            <h4 class="fw-bold py-3 mb-4 ">Evaluator Management&nbsp;&nbsp;<a href="javascript:void(0)"
                    wire:click="resetdata()" class="btn  rounded-pill btn-icon btn-outline-primary" data-bs-toggle="modal"
                    data-bs-target="#evaluatorModal">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" wire:click="edit({{ $data->id }})"
    ...
    <div class="modal fade " id="evaluatorModal" wire:ignore.self data-bs-backdrop="static" tabindex="-1"
