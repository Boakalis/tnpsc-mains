...
const Register = React.forwardRef((props, ref) => {
  ...
  const registerModalState = useSelector(
    (state) => state.modalReducer.isRegisterOpen
  );
  ...
  return (
    <>
      {createPortal(
        <>
          <div
            className={`modal  ${registerModalState ? "is-open" : "d-none"}`}
          >
              ...
              <div className="modal-left">
                ...
                <div className="modal-buttons">
                  <span style={{ fontSize: "10px" }} href="" className="col-12">
                    ...
                    <a style={{ fontSize: "10px", color: "blue" }} href="">
                ...
                <p className="sign-up mt-3">
                  ...
                  <a href="javascipt:void(0)" onClick={openLoginModal}>
                    Login Now
                  </a>
                </p>
              </div>
