...
function Profile() {
  ...
  const validation = (event) => {
      ...
      if(!email.current.value.includes('@') || !email.current.value.includes('.') || !email.current.value.includes('com') ){
        toastr.error('Email is invalid','Please Enter proper Email Address')
        email.current.focus();
        setTimeout(()=>{
            toastr.removeByType('error')
        },5000)
      ...
      if(phone.current.value == ''){
        toastr.error('Phone Number is required','Please Enter Phone Number')
        phone.current.focus();
        setTimeout(()=>{
            toastr.removeByType('error')
        },5000)
      ...
      if(isNaN(phone.current.value) || phone.current.value.length < 6 ){
        toastr.error('Phone Number is invalid','Please Enter proper Phone Number')
        phone.current.focus();
        setTimeout(()=>{
            toastr.removeByType('error')
        },5000)
      ...
      if(address1.current.value == ''){
        toastr.error('Address field 1 is required','Please Enter proper address')
      ...
      if(address1.current.value.length < 3){
        toastr.error('Address field 1 too short','Please enter proper address')
        address1.current.focus();
        setTimeout(()=>{
            toastr.removeByType('error')
        },5000)
            ...
            <div className=" col-12">
              <div className="card mb-4">
                <div className="card-body">
                  <h4 className="text-center my-3">Personal Details</h4>
                  <form className="row">
                    ...
                    <h4 className="text-center my-4">Communication Details</h4>
                    <div className="row mb-3 col-6 ">
                      <label
                        class="form-label"
                    ...
                    <div className="row my-3 justify-content-end">
                      <div className="col-12">
                        <button type="submit" id="submit" className="btn btn-primary" onClick={validation}>
                          <CircularProgress size="1rem" color="error" className="d-none" id="loaderCircle" /> <span id="text">Update Profile</span> 
                        </button> 
                      </div>
                    </div>
                  </form>
