                                                        ...
                                                        <tr>
                                                            <td style="width:100%;padding-right:0px;padding-left:0px;">
                                                                <div align="center" style="line-height:10px"><img
                                                                        ...
                                                                        class="big"
                                                                        src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path("images/animated_header.gif")))); ?>"
                                                            ...
                                                            <td>
                                                                <div style="font-family: sans-serif">
                                                                    <div class="txtTinyMce-wrapper"
                                                                        style="font-size: 14px; mso-line-height-alt: 16.8px; color: #40507a; line-height: 1.2; font-family: Helvetica Neue, Helvetica, Arial, sans-serif;">
                                                                        <p style="margin: 0; font-size: 14px;"><span
                                                                                style="font-size:16px;">Please use this below OTP to reset password</span></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                                   ...
                                                                   ><span
                                                                        style="padding-left:25px;padding-right:20px;font-size:15px;display:inline-block;letter-spacing:normal;"><span
                                                                            style="font-size: 16px; line-height: 2; word-break: break-word; mso-line-height-alt: 32px;"><span
                                                                                ...
                                                                                style="font-size: 15px; line-height: 30px;"><strong><?php echo e(@$details['otp']); ?></strong></span></span></span></a>
                                                        ...
                                                        <tr>
                                                            <td style="width:100%;padding-right:0px;padding-left:0px;">
                                                                <div align="center" style="line-height:10px"><img
                                                                        ...
                                                                        class="big"
                                                                        src="data:image/png;base64,<?php echo e(base64_encode(file_get_contents(public_path('/images/bottom_img.png')))); ?>"
...
<?php /**PATH F:\xampps\htdocs\tnpsc-mains\resources\views/emails/password.blade.php ENDPATH**/ ?>