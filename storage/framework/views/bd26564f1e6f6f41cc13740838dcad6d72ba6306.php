                            ...
                            <div class="col-xl-9 col-lg-9">
                                <div class="menu-wrapper d-flex align-items-center justify-content-end">
                                    ...
                                    <div class="main-menu d-none d-lg-block">
                                        <nav>
                                            <ul id="navigation">
                                                <li class="  active"><a class="py-4" href="<?php echo e(route('home')); ?>">Home</a></li>
                                                <li><a class="py-4" href="/exams">Courses</a></li>
                                                <li><a class="py-4" href="<?php echo e(route('about')); ?>">About</a></li>
                                                <li><a class="py-4" href="<?php echo e(route('contact')); ?>">Contact</a></li>
                                                <!-- Button -->
        ...
        <section class="contact-section">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <form class="form-contact contact_form" action="<?php echo e(route('contact.submit')); ?>" method="post"
                            id="contactForm" novalidate="novalidate">
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <textarea class="form-control w-100" name="message" id="message" cols="30" rows="9"
                                            onfocus="this.placeholder = ''" required onblur="this.placeholder = 'Enter Message'" placeholder=" Enter Message"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input class="form-control valid" required name="name" id="name"
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input class="form-control valid" name="email" required id="email"
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <input class="form-control" name="subject" id="subject" required type="text"
...
<?php /**PATH F:\xampps\htdocs\tnpsc-mains\resources\views/contact.blade.php ENDPATH**/ ?>